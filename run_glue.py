...
def parse_args():
    ...
    parser.add_argument(
        "--svd_init",
        action="store_true",
        help="Whether or not to initialize the low-rank adapter by SVD.",
    )
    parser.add_argument(
        "--act_quant",
        action="store_true",
        help="Whether or not to enable activation quantization.",
    )
    parser.add_argument(
        "--num_bits",
        type=int,
...
def main():
    ...
    model, model_teacher, optimizer, train_dataloader, eval_dataloader, lr_scheduler = accelerator.prepare(
        model, model_teacher, optimizer, train_dataloader, eval_dataloader, lr_scheduler
    )
